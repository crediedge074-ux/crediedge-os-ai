import { Plus, CircleCheck as CheckCircle2 } from "lucide-react";
  ...
  return (
    <div className="flex h-full flex-col rounded-xl border border-border bg-card p-5 shadow-soft">
      <div className="mb-4 flex items-center justify-between">
        ...
        <button className="rounded-lg border border-border bg-card px-3 py-1.5 text-[11px] font-medium text-foreground transition-colors duration-150 hover:bg-secondary">
          Manage
        </button>
      </div>
      ...
      <div className="grid flex-1 grid-cols-2 gap-2.5 sm:grid-cols-3 lg:grid-cols-4 xl:grid-cols-4">
              ...
              <div className="mt-0.5 flex items-center justify-center gap-1 text-[10px] text-muted-foreground">
                <span
                  className={`h-1.5 w-1.5 rounded-full ${
                    it.health === "healthy" ? "bg-success" : "bg-warning"
                  }`}
                />
                {it.lastSync}
              </div>
        ...
        <button className="flex flex-col items-center justify-center gap-2 rounded-xl border border-dashed border-border p-3.5 text-muted-foreground transition-all duration-200 hover:border-foreground/30 hover:bg-secondary hover:text-foreground">
